<script>
  ...
  import { Check, X, CreditCard, History, Download } from '$lib/utils/lucide-compat.js';
...
<div class="grid-stack-item">
  <!-- Existing HTML content of the page will go here -->
  <!-- Billing Header - Treat as Gridstack item -->
  ...
  <!-- Current Plan Section - Treat as Gridstack item -->
  <div class="grid-stack-item" data-gs-no-resize="true" data-gs-no-move="true" data-gs-auto-position="true" data-gs-width="12" data-gs-height="auto">
    <div class="grid-stack-item-content">
      <Card class="mb-8">
        <CardHeader>
  ...
  <!-- Billing History Section - Treat as Gridstack item -->
  <div class="grid-stack-item" data-gs-no-resize="true" data-gs-no-move="true" data-gs-auto-position="true" data-gs-width="12" data-gs-height="auto">
    <div class="grid-stack-item-content">
      <Card>
        <CardHeader>
